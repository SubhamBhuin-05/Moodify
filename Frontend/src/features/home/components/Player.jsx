...
const Player = () => {
  ...
  const titleRef = useRef(null); // ✅ ref for overflow check
  ...
  const [isOverflowing, setIsOverflowing] = useState(false); // ✅ marquee state
  ...
  // ✅ Check if title overflows whenever song changes
  useEffect(() => {
    if (titleRef.current) {
    ...
    <div className="player">
      ...
      <div className="player__info">
        ...
        <div className="player__meta">
          {/* ✅ Marquee title */}
          <div className="player__title" ref={titleRef}>
            {isOverflowing ? (
              <span>
                {song.title}
                {song.year ? ` (${song.year})` : ""}
          ...
          <p className="player__artist" data-album={song.album}>
            {song.artist}
          </p>
